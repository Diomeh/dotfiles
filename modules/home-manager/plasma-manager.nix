...

{
  ...
  programs.plasma = {
    enable = true;
    shortcuts = {
      "ActivityManager"."switch-to-activity-521dee40-2914-4188-8e3f-abe66eaccefc" = [ ];
    ...
    configFile = {
      ...
      "dolphinrc"."General"."ViewPropsTimestamp" = "2024,5,3,15,20,19.615";
      ...
      "kactivitymanagerdrc"."activities"."521dee40-2914-4188-8e3f-abe66eaccefc" = "Default";
      "kactivitymanagerdrc"."main"."currentActivity" = "521dee40-2914-4188-8e3f-abe66eaccefc";
      ...
      "katerc"."KTextEditor::Search"."Search History" = "name,wrap,wrap_lines,exec,exec\\,,program";
      ...
      "kcminputrc"."Libinput/1739/52861/SYNA32B8:00 06CB:CE7D Touchpad"."Enabled" = true;
      ...
      "kdeglobals"."DirSelect Dialog"."DirSelectDialog Size" = "1440,848";
      ...
      "kdeglobals"."KFileDialog Settings"."Preview Width" = 229;
      ...
      "khotkeysrc"."Data_2_1Triggers0"."Uuid" = "{4170192b-b5f1-45dd-bb13-423531ba6b0b}";
      ...
      "khotkeysrc"."Data_2_2Triggers0"."Uuid" = "{d40b4af9-0e5a-40e1-a5e4-281a0ea3afe2}";
      ...
      "khotkeysrc"."Data_2_3Triggers0"."Uuid" = "{3f4e3fce-c311-4f23-899e-95557b784188}";
      ...
      "khotkeysrc"."Data_2_4Triggers0"."Uuid" = "{a7b637da-24bd-4d62-aa33-8af7d41b7ece}";
      ...
      "khotkeysrc"."Data_2_5Triggers0"."Uuid" = "{c8317d60-2a9f-4b9d-addd-5d5da15e9af0}";
      ...
      "khotkeysrc"."Data_2_6Triggers0"."Uuid" = "{3cdb5fbc-a5ed-4c2c-ab98-a706ac2f2a00}";
      ...
      "khotkeysrc"."Data_2_8Triggers0"."Uuid" = "{4f944dde-2140-4c22-87e8-261b86d9452a}";
      ...
      "kwinrc"."Desktops"."Id_1" = "177d394e-247e-46cc-9c8c-32e233a8f491";
      ...
      "kwinrc"."Tiling/676aedbe-f200-5fdc-9719-2ca45c44f5aa"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/741c431b-02ef-538f-983d-a5e79c65b57b"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/8a443408-7645-5e79-bc4d-6a7f1d660971"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/8b587795-04f5-508e-ac14-f9388cd16e82"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      ...
      "kwinrc"."Tiling/f58905e1-03c1-58a9-aa4f-8fe2529a5016"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Xwayland"."Scale" = 1;
      "kwinrc"."org.kde.kdecoration2"."theme" = "__aurorae__svg__Sweet-Dark-transparent";
      "plasma-localerc"."Formats"."LANG" = "en_GB.UTF-8";
      "plasma-localerc"."Formats"."LC_MEASUREMENT" = "es_CO.UTF-8";
      ...
      "plasmarc"."Wallpapers"."usersWallpapers" = "/home/diomeh/Downloads/wallpaperflare.com_wallpaper.jpg,/home/diomeh/Downloads/wallpaperflare.com_wallpaper-l.jpg";
      ...
      "spectaclerc"."ImageSave"."lastImageSaveAsLocation" = "file:///home/diomeh/Pictures/Screenshots/Screenshot__.png";
      "spectaclerc"."ImageSave"."lastImageSaveLocation" = "file:///home/diomeh/Pictures/Screenshots/Screenshot_20240928_101045.png";
      "spectaclerc"."ImageSave"."translatedScreenshotsFolder" = "Screenshots";
      "spectaclerc"."Save"."compressionQuality" = 100;
      "spectaclerc"."Save"."lastSaveLocation" = "file:///home/diomeh/Pictures/Screenshot_20240507_003313.png";
    ...
    dataFile = {
      ...
      "dolphin/view_properties/global/.directory"."Dolphin"."VisibleRoles" = "CustomizedDetails,Details_text,Details_type,Details_extension,Details_size,Details_modificationtime";
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-Sidebar-0-Splitter" = 920;
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-Sidebar-1-Splitter" = 920;
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-V-Splitter" = "0,918,0";
